                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="max-w-md">
                        ...
                        <FadeInStagger className="space-y-12">
                            {steps.map((step) => (
                                <FadeInStaggerItem key={step.num} direction="left">
                    ...
                    <div className="relative">
                        <FadeIn direction="left" delay={0.4}>
                            ...
                            <div className="bg-[#f0f2f6] rounded-[30px] p-8 md:p-12 lg:p-16">
                                ...
                                <div className="rounded-[30px] shadow-[0_32px_64px_-12px_rgba(124,58,237,0.3)] border border-gray-100 overflow-hidden transform scale-[1.02]">
