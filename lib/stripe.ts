...
if (!process.env.STRIPE_SECRET_KEY) {
    console.warn("STRIPE_SECRET_KEY is not defined. Using dummy key. Actual Stripe calls will fail.");
}

export const stripe = new Stripe(process.env.STRIPE_SECRET_KEY || "dummy_key_for_testing", {
